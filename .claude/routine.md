...
When the user references a file by bare name (e.g. `main.js`), it lives in `WeatherApp_main/src//`. When they reference a test file (e.g. `main.test.js`), it lives in `tests//`.
...
>
> - **Data layer routing:** "All data-model mutations must go through `WeatherApp_main/src//dataLayer.js`. Direct localStorage writes are prohibited."
...
> - **Known fragile files:** "WeatherApp_main/src//legacy.js is in active rewrite — changes there require extra care."
...
>
> - "WeatherApp_main/src//main.js evaluates module-level code twice due to webpack entry-bundle structure. Use one-shot guards for listener registration."
...
>
> - "WeatherApp_TOP is a single-page app; routing is hash-based via {{ROUTER_FILE}}."
> - "The main state container is {{STATE_FILE}} — global state mutations flow through there."
> - "UI components live in WeatherApp_main/src//components/; pages in WeatherApp_main/src//pages/."
>
