...
- `drafted`:
  `{"state":"drafted","draft":"<full TODO.md entry>","file_paths":["WeatherApp_main/src/...","..."],"thread":[{"role":"agent","text":"Drafted — ready to dispatch.","ts":"<now>"}]}`
...
- [ ] **[PRIORITY]** <Imperative verb + specific change>
  ...
  - File: `WeatherApp_main/src/<file>`, `WeatherApp_main/src/<file>`
...
- File paths full and repo-relative — `WeatherApp_main/src/<file>`, never a bare filename.
  Source under `WeatherApp_main/src/`, tests under `tests/`.
